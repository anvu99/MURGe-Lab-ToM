...
SLURM submission (2 GPUs, 128 GB RAM):
    sbatch evaluation/submit_eval_gemma_llama.sl
...
Or interactive:
    ...
    python -m evaluation.run_eval_hetero_gemma_llama

Outputs:
  evaluation/metrics_log_hetero_gemma9B_llama8B_...csv
  evaluation/tom_memories_log_hetero_gemma9B_llama8B_...json
"""
...
def truncate_slurm_err_log():
    ...
    job_name = os.environ.get("SLURM_JOB_NAME", "eval_gemma_llama")
    if not job_id:
...
def main():
    ...
    csv_file = f"evaluation/metrics_log_hetero_gemma9B_llama8B_{job_id}.csv"
    memory_log_file = f"evaluation/tom_memories_log_hetero_gemma9B_llama8B_{job_id}.json"
    ...
    summary_file = f"evaluation/final_summary_hetero_gemma9B_llama8B_{job_id}.json"
