...
def truncate_slurm_err_log():
    ...
    job_name = os.environ.get("SLURM_JOB_NAME", "eval_qwen_llama")
    if not job_id:
...
def main():
    ...
    csv_file = f"evaluation/metrics_log_hetero_qwen7B_llama8B{job_id}.csv"
    memory_log_file = f"evaluation/tom_memories_log_hetero_qwen7B_llama8B{job_id}.json"
    ...
    summary_file = f"evaluation/final_summary_hetero_qwen7B_llama8B{job_id}.json"
