#!/usr/bin/env python3
"""
3-Agent Think-Then-Speak debate evaluation (with persistent memories).
...
def main():
    ...
    base_name = f"3agent_tts_{job_id}_with_memories"
    csv_file = f"evaluation/metrics_log_{base_name}.csv"
    memory_log_file = f"evaluation/tom_memories_log_3agent_tts_{job_id}.json"
